...
export default function SpecialityDetails({ params: { id } }) {
    ...
    return <div className="Specialitys recent--specialitys">
        <div className="title">
            <h2 className="section--title"> Speciality Details</h2>
            <Link href="/specialitys">
                <button className="add">View All</button>
            </Link>
        </div>
        <h4 className="section--title mt-5 ">Speciality Info</h4>
        ...
        <h4 className="section--title mt-5 ">Speciality Referrals</h4>
        ...
        <h4 className="section--title mt-5 ">Speciality Providers</h4>
